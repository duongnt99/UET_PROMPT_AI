...
const envSchema = z.object({
  ...
  EMAIL_PROVIDER: z.preprocess((value) => value === "" ? undefined : value, z.enum(["console", "resend", "smtp", "gmail-api"]).optional()),
  EMAIL_FROM: z.string().optional(),
  EMAIL_FROM_ADDRESS: z.preprocess((value) => value === "" ? undefined : value, z.string().email().optional()),
  EMAIL_FROM_NAME: z.string().default("AI Arena Viet Nam"),
  GOOGLE_CLIENT_ID: z.string().optional(),
  GOOGLE_CLIENT_SECRET: z.string().optional(),
  GOOGLE_REFRESH_TOKEN: z.string().optional(),
  GOOGLE_GMAIL_USER: z.preprocess((value) => value === "" ? undefined : value, z.string().email().optional()),
